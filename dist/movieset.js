...
var mdb = require('moviedb')(undefined);
...
var deleteDuplicates = exports.deleteDuplicates = function deleteDuplicates(arr) {
  var movies = [];
  var titles = [];
...
var intersect = function intersect(arr1, arr2) {
  var intersect = [];
  var allMovies = (0, _union2.default)(arr1, arr2
  //we need the movie to be contained in all of the people's work.
  );(0, _each2.default)(allMovies, function (movie) {
    if ((0, _some2.default)(arr1, { title: movie.title }) && (0, _some2.default)(arr2, { title: movie.title }) && !(0, _some2.default)(intersect, { title: movie.title })) {
...
var createResults = exports.createResults = function createResults(res, movies, useBigPosters) {
  var arr = null;
  ...
  (0, _each2.default)(arr, function (movie) {
    ...
    for (var _actor in movies) {
      var actorJob = (0, _find2.default)(movies[_actor], { title: movie.title });
